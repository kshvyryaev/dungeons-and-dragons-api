...
{
    public class CreateCharacterValidator : AbstractValidator<CreateCharacterCommand>, ICommandValidator<CreateCharacterCommand, Character>
    {
        public CreateCharacterValidator(ICharactersRepository<ObjectIdentifier> charactersRepository)
        {
            RuleFor(c => c.Name)
                .NotEmpty()
        ...
        public void ValidateAndThrowIfFailed(CreateCharacterCommand command, Character sourceEntity = null)
        {
